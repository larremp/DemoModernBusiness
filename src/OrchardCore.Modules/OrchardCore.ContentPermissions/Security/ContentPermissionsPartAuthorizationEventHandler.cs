...
namespace OrchardCore.ContentPermissions.Security
{
    public class ContentPermissionsPartAuthorizationEventHandler : IAuthorizationServiceEventHandler {
        ...
        public ContentPermissionsPartAuthorizationEventHandler(HttpContextAccessor httpContextAccessor) {
        ...
        public void Complete(CheckAccessContext context) {
            ...
            if (context.User != null) {
                var superuser = _httpContextAccessor.HttpContext.CurrentSite.SuperUser;
